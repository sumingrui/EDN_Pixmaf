...
CUBE_PARTS_FILE = 'pixmaf_data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = 'pixmaf_data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M = 'pixmaf_data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = 'pixmaf_data/vertex_texture.npy'
